...
<?php include_javascripts_for_form($form) ?>
  ...
  <?php include_partial('post/show_header', array( 'post' => $post, 'helper' => $helper)) ?>
...
<div class="content-box">
    <div class="content-box-header">
		...
		<div id="sf_fieldset_<?php echo preg_replace('/[^a-z0-9_]/', '_', strtolower($fieldset)) ?>">
			...
			<?php if ($field->isPartial()): ?>
		      <?php include_partial('post/'.$name, array('post' => $post, 'form' => $form, 'attributes' => $attributes instanceof sfOutputEscaper ? $attributes->getRawValue() : $attributes)) ?>
		    <?php elseif ($field->isComponent()): ?>
		      <?php include_component('post', $name, array('post' => $post, 'form' => $form, 'attributes' => $attributes instanceof sfOutputEscaper ? $attributes->getRawValue() : $attributes)) ?>
		    <?php else: ?>
  ...
  <?php include_partial('post/show_footer', array('post' => $post, 'helper' => $helper)) ?>
