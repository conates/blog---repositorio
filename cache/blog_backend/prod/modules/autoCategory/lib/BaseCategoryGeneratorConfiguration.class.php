 ...
 */
abstract class BaseCategoryGeneratorConfiguration extends mpRealtyAdminGeneratorConfiguration
{
  ...
  {
    return 'Editando Categoría %%name%%';
  }
...
{
  $max_per_page = sfContext::getInstance()->getUser()->getAttribute('category.max_per_page', null, 'admin_module');
  ...
  {
    return "Category_Export_".date("d_m_Y_His");
  }
}
