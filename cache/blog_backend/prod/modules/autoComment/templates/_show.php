...
<?php include_javascripts_for_form($form) ?>
  ...
  <?php include_partial('comment/show_header', array( 'comment' => $comment, 'helper' => $helper)) ?>
...
<div class="content-box">
    <div class="content-box-header">
		...
		<div id="sf_fieldset_<?php echo preg_replace('/[^a-z0-9_]/', '_', strtolower($fieldset)) ?>">
			...
			<?php if ($field->isPartial()): ?>
		      <?php include_partial('comment/'.$name, array('comment' => $comment, 'form' => $form, 'attributes' => $attributes instanceof sfOutputEscaper ? $attributes->getRawValue() : $attributes)) ?>
		    <?php elseif ($field->isComponent()): ?>
		      <?php include_component('comment', $name, array('comment' => $comment, 'form' => $form, 'attributes' => $attributes instanceof sfOutputEscaper ? $attributes->getRawValue() : $attributes)) ?>
		    <?php else: ?>
  ...
  <?php include_partial('comment/show_footer', array('comment' => $comment, 'helper' => $helper)) ?>
