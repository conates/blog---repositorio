...
<div class="sf_admin_filter_content">
  ...
  <form action="<?php echo url_for('sf_guard_user_collection', array('action' => 'filter')) ?>" method="post">
      ...
      <div class="field">
	  <?php echo link_to(__('Reset', array(), 'sf_admin'), 'sf_guard_user_collection', array('action' => 'filter'), array('query_string' => '_reset', 'class' => 'blocFilter_reset graybutton f_left')) ?>
