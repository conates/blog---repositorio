...
<div id="container">
    <div id="header" class="png_bg">
        <div id="head_wrap">
            <div id="logo">
                <h1><a href="#"><?php echo sfConfig::get('app_title_login');?></span></a></h1>
            </div>
            <div class="clear"></div>
            ...
            <div id="login-inner">
                <form id="loginform" action="<?php echo url_for('@sf_guard_signin') ?>" method="post">
                    ...
                    <div class="bloc_field">
                        <label><?php echo __('Usuario', array(), 'mpRealityAdmin'); ?></label><br/>
                    ...
                    <?php endif; ?>
                     ...
                     <label for="login-check"><?php echo __('Recordar?', array(), 'mpRealityAdmin'); ?></label><br/>
                    <input type="submit" value="<?php echo __('Enviar', array(), 'mpRealityAdmin'); ?>" class="submit-login"  />
