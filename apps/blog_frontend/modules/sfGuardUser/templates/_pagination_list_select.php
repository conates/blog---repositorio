...
$currentMaxPerPage = $sf_user->getAttribute('sfGuardGroup.max_per_page', $pager->getMaxPerPage(),'admin_module');
?>
...
function changePageSize(val){
        var newLocation = "<?php echo url_for('@sf_guard_group') ?>?maxPerPage="+val;
